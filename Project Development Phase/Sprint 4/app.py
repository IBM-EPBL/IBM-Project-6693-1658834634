...
def index():
    if request.method == 'POST':
        ...
        API_KEY = "biPcXk87hEAVGJmshvmAydVkKHFDh3SGkhumQrT6rr5f"
        ...
        payload_scoring = {"input_data": [{"field": [["GRE Score","TOEFL Score","University Rating","SOP","LOR","CGPA", "Research"]], "values": [[316, 120, 3, 3, 4, 8, 1]]}]}

        response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/5c30a301-737b-47d6-8b9f-c247ae50d390/predictions?version=2022-11-24', json=payload_scoring,
         headers={'Authorization': 'Bearer ' + mltoken})
        response_scoring = response_scoring.json()

        #model = joblib.load('UniversityEligibilityPredictionModel.pkl')
